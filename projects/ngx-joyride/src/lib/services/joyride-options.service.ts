...
export interface ObservableCustomTexts extends ICustomTexts {
    prev: Observable<string>;
    next: Observable<string>;
    done: Observable<string>;
    close: Observable<string | null>;
}
...
export class JoyrideOptionsService implements IJoyrideOptionsService {
    ...
    private firstStep: string | undefined;
    private waitingTime: number = DEFAULT_TIMEOUT_BETWEEN_STEPS;
    private customTexts: ObservableCustomTexts = DEFAULT_TEXTS;
    ...
    private setCustomText(texts: CustomTexts) {
        ...
        let done: string | Observable<string>;
        let close: string | Observable<string | null>;
    ...
    private toObservable(value: string | Observable<string | null>) {
