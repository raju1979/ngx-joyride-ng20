...
export class JoyrideStepComponent implements OnInit, OnDestroy, AfterViewInit {
    ...
    private stepAbsoluteLeft = 0;
    private stepAbsoluteTop = 0;
    private targetWidth = 0;
    targetHeight = 0;
    private targetAbsoluteLeft = 0;
    private targetAbsoluteTop = 0;

    private subscriptions: Subscription[] = [];
    joyrideStepService!: IJoyrideStepService;

    private positionAlreadyFixed = false;
    ...
    private checkRedraw(val: string) {
        if (val != null) {
