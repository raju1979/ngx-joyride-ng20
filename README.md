...
An Angular Tour (Joyride) library built entirely in Angular (20), without using any heavy external dependencies like Bootstrap or JQuery.
From now on you can easily guide your users through your site showing them all the sections and features.
This library is exactly the clone of [joyride](https://www.npmjs.com/package/ngx-joyride)
For Angular 20
